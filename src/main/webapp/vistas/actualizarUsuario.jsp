                        ...
                        <tbody>
                            <%
                                ...
                                while(iter.hasNext()){
                                    ...
                                    %>
                                    <form action="SvSaveUser" method="post">
                                        <tr>
                                            <td class="text-center"><%= u.getId() %></td>
                                            <td> <input placeholder="<%= u.getNombre() %>" name="nombre"> </td>
                                            <td> <input placeholder="<%= u.getApellido() %>" name="apellido"> </td>
                                            <td> <input placeholder="<%= u.getDni() %>" name="DNI"> </td>
                                            <td> <input placeholder="<%= u.getContacto() %>" name="contacto"> </td>
                                            <td class="actions"> 
